        ...
        <div className=' w-full text-center'>
            ...
            <form action="https://getform.io/f/3d8f8591-95c3-4d7b-8461-5905a8bd095b" method='POST'>
              <div className='w-full lg:w-1/2 m-auto mt-12  lg:mt-20 flex flex-col  gap-5'>
                  ...
                  <input type="text" name="name" required id="" className=' rounded-lg  text-lg font-normal p-2 text-black ' placeholder='Enter your name' />
                  <input type="email" name="email" id="" required className=' rounded-lg  text-lg font-normal p-2 text-black  ' placeholder='Enter your email' />

<textarea name="message" id="" cols="5" rows="5" placeholder='Enter your Message' required className=' rounded-lg text-lg font-medium focus:outline-none p-3'></textarea>
